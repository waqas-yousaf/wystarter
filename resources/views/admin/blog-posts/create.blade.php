        ...
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
            ...
            <div class="lg:col-span-2 space-y-5">
                ...
                <div>
                    <label for="excerpt" class="block text-sm font-medium text-gray-700 mb-1">
                        Excerpt <span class="text-gray-400 text-xs font-normal">(optional, max 500 chars)</span>
                    </label>
                    <textarea id="excerpt" name="excerpt" rows="2" maxlength="500"
                              class="block w-full rounded-lg border border-gray-300 px-3 py-2 text-sm shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500">{{ old('excerpt') }}</textarea>
                </div>
            ...
            <div class="space-y-5">
                ...
                <div class="bg-white rounded-xl border border-gray-200 p-4">
                    ...
                    <p class="text-xs text-gray-400 mb-2">Comma-separated — created automatically</p>
